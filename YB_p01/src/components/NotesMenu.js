...
const NotesMenu = () => {
    ...
    return (
        <div className="flex flex-col items-center">
            <button onClick={() => setShowMenu(!showMenu)} className="focus:outline-none focus:ring-4 focus:ring-coolGray-400 bg-coolGray-900 w-10 h-10 rounded-full flex items-center justify-center transition duration-300 ease-in-out" style={{ transform: (showMenu ? "rotate(45deg)" : "rotate(0deg)") }}>
...
const Menu = () => {
    const colors = ["red", "green", "orange", "blue", "violet"];
    return (
